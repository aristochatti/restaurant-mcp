...
async def fetch_from_list(url: str, enrich: bool = False) -> list[dict[str, Any]]:
    """
    ...
    # Step 3: Parse places (optionally enriched)
    parsed = parse_places(raw_data, api_key=api_key if enrich else None)
